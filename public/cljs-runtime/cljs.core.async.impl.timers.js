...
while(true){
if((i <= self__.level)){
var links_13705 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_13705[i]));
} else {
x__$2.forward.push((((i < links_13705.length))?(links_13705[i]):null));
}

if((i < links_13705.length)){
(links_13705[i] = x__$2);
} else {
links_13705.push(x__$2);
}
...
var i_13711 = (0);
while(true){
if((i_13711 <= self__.level)){
var links_13712 = (update[i_13711]).forward;
if((x__$1 === (((i_13711 < links_13712.length))?(links_13712[i_13711]):null))){
(links_13712[i_13711] = (x__$1.forward[i_13711]));

var G__13714 = (i_13711 + (1));
i_13711 = G__13714;
continue;
} else {
var G__13715 = (i_13711 + (1));
i_13711 = G__13715;
continue;
}
} else {
...
var G__13719 = nx;
var G__13720 = (level__$1 - (1));
x = G__13719;
level__$1 = G__13720;
continue;
} else {
var G__13722 = x;
var G__13723 = (level__$1 - (1));
x = G__13722;
level__$1 = G__13723;
continue;
}

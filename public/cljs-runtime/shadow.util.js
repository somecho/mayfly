...
var len__5769__auto___13801 = arguments.length;
var i__5770__auto___13802 = (0);
while(true){
if((i__5770__auto___13802 < len__5769__auto___13801)){
args_arr__5794__auto__.push((arguments[i__5770__auto___13802]));

var G__13803 = (i__5770__auto___13802 + (1));
i__5770__auto___13802 = G__13803;
continue;
} else {
}
break;
...
/** @this {Function} */
(shadow.util.log.cljs$lang$applyTo = (function (seq13635){
...
var G__13638 = cljs.core.first(seq13635__$2);
var seq13635__$3 = cljs.core.next(seq13635__$2);
var G__13639 = cljs.core.first(seq13635__$3);
var seq13635__$4 = cljs.core.next(seq13635__$3);
var G__13640 = cljs.core.first(seq13635__$4);
var seq13635__$5 = cljs.core.next(seq13635__$4);
var G__13641 = cljs.core.first(seq13635__$5);
var seq13635__$6 = cljs.core.next(seq13635__$5);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13636,G__13637,G__13638,G__13639,G__13640,G__13641,seq13635__$6);
}));

(shadow.util.log.cljs$lang$maxFixedArity = (6));

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__13735){
var vec__13751 = p__13735;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13751,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13751,(1),null);

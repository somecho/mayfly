...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_18028 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_18028(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_18029 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_18029(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_18030 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_18030(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_18034 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_18034(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_18035 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_18035(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_18036 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_18036(reader);
}
});
...
var G__18048 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__18049 = s.append(c);
c = G__18048;
s = G__18049;
continue;
}
